...
% beam positin(BP) 
%% system parameters
N = 12; % total beam spot number 60
K = 4; % beam spot number per slot 25
...
P_tot = [80:20:160];
penalty_thresh = [14 14.5 15 15.5 16 16.5 17 17.5];
...
save('NonPrd_non_N12_penlty8.mat')
